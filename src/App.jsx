  ...
  return (
    <div className={`h-screen bg-black flex flex-col items-center justify-center p-6 text-white ${isRtl ? 'rtl' : 'ltr'}`}>
       ...
       <div className="w-full max-w-sm mt-4">
          <button onClick={handleGoogleLogin} className="w-full py-4 bg-white text-black rounded-2xl font-bold flex items-center justify-center gap-3 border border-gray-200 active:scale-95 transition-all">
            ...
            {isRtl ? 'الدخول بواسطة جوجل' : 'Sign in with Google'}
          </button>
       </div>
